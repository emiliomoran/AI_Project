...
dataset_X_reimported = pd.read_csv('https://raw.githubusercontent.com/emiliomoran/AI_Project/master/Encoded_X2.csv')
dataset_y_reimported = pd.read_csv('https://raw.githubusercontent.com/emiliomoran/AI_Project/master/Encoded_y%20-%20revenue2.csv')
